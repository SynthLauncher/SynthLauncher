...
use crate::modrinth::{
    api::project::{
        get_modrinth_project_versions, query_project_version, ModrinthProjectVersion, ProjectType,
    },
    mrpack::{copy_overrides, download_modpack_files, read_modrinth_index, unzip_modpack},
};
...
pub async fn download_modrinth_modpack<'a>(
    ...
    let project_version =
        query_project_version(instance_manager.requester(), slug, version).await?;
