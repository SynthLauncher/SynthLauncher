...
import { StoreCardProps } from '@/lib/types/store/store';
	...
	return (
		<div className="bg-[#1D2026] rounded-lg p-5 flex gap-3">
			...
			<div className="flex flex-col grow">
				<h1 className="text-white text-lg font-bold flex gap-2 items-center">
					{name}
					<span className="text-gray-500 font-normal">by {author}</span>
				</h1>
